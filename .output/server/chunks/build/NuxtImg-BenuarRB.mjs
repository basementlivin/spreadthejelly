import { defineComponent, ref, provide, createElementBlock, useAttrs, computed, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs } from 'vue/server-renderer';
import { u as useHead, j as useNuxtApp, k as useRuntimeConfig } from './server.mjs';
import { n as hasProtocol, H as withLeadingSlash, o as joinURL, I as parseURL, l as defu, J as stringifyQuery, p as parseQuery } from '../runtime.mjs';
...
const getImage = (src, { modifiers = {}, baseURL = PRISMIC_IMGIX_BUCKET } = {}) => {
...
const prismicRuntime$EqImJ1rhGj = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage
...
imageOptions.providers = {
  ["prismic"]: { provider: prismicRuntime$EqImJ1rhGj, defaults: {} }
};
const useImage = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const nuxtApp = useNuxtApp();
    nuxtApp.isHydrating;
    return (_ctx, _push, _parent, _attrs2) => {
...
//# sourceMappingURL=NuxtImg-BenuarRB.mjs.map
