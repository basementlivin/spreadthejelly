...
const YouTubeIcon = { render() {
  return h(NuxtIcon, { icon: { render }, name: "social--youtube" });
} };

export { YouTubeIcon as default, render };
//# sourceMappingURL=social--youtube-BgYEpkwn.mjs.map
