...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"An editorial resource & storytelling platform for every motherhood journey."},{"name":"format-detection","content":"telephone=no"},{"name":"referrer","content":"no-referrer-when-downgrade"},{"name":"robots","content":"noindex, nofollow"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"}],"style":[],"script":[],"noscript":[],"title":"Spread the Jelly","htmlAttrs":{"lang":"en"}};
